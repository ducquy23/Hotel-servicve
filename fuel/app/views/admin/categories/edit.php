    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Sửa Loại Khách sạn</h2>
    ...
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?= \Uri::create('admin/categories/edit/' . $row['id']) ?>">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-1">
                        ...
                        <div class="col-md-6">
                            <div class="mb-1">
                                <?= \View::forge('admin/components/icon_picker', array(
                                    'name' => 'icon',
                                    'value' => \Input::post('icon', $row['icon']),
                                    'id' => 'icon'
                                )) ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-1">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="4"
                                          placeholder="Mô tả về loại khách sạn..."><?= \Input::post('description', $row['description']) ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button type="submit" class="btn btn-primary me-1">Cập nhật loại khách sạn</button>
